...
- Uso de Imagenes
    - Parametros:
        ...
        - options = "{'preview_image': 'image_128', 'size': ['',128]}"
            ...
            - size : Configuracion del alto y ancho, si se deja '' tomara el valor por default de el alto de la imagen

- Las etiquetas que aparecen al lado de un label sólo apareceran siempre y cuando esten dentro de una etiqueta <group>
``` 